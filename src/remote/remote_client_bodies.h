...
static char *
remoteDomainGetXMLDesc(virDomainPtr dom, int flags)
{
    char *rv = NULL;
    struct private_data *priv = dom->conn->privateData;
...
static char *
remoteNetworkGetXMLDesc(virNetworkPtr net, int flags)
{
    char *rv = NULL;
    struct private_data *priv = net->conn->networkPrivateData;
...
static char *
remoteNWFilterGetXMLDesc(virNWFilterPtr nwfilter, int flags)
{
    char *rv = NULL;
