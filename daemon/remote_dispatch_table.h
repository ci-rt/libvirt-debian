...
{   /* DomainGetXMLDesc => 14 */
    .fn = (dispatch_fn) remoteDispatchDomainGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_domain_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_domain_get_xml_desc_ret,
},
...
{   /* NetworkGetXMLDesc => 43 */
    .fn = (dispatch_fn) remoteDispatchNetworkGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_network_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_network_get_xml_desc_ret,
},
...
{   /* StoragePoolGetXMLDesc => 88 */
    .fn = (dispatch_fn) remoteDispatchStoragePoolGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_storage_pool_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_storage_pool_get_xml_desc_ret,
},
...
{   /* StorageVolGetXMLDesc => 99 */
    .fn = (dispatch_fn) remoteDispatchStorageVolGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_storage_vol_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_storage_vol_get_xml_desc_ret,
},
...
{   /* NodeDeviceGetXMLDesc => 114 */
    .fn = (dispatch_fn) remoteDispatchNodeDeviceGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_node_device_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_node_device_get_xml_desc_ret,
},
...
{   /* DomainSnapshotGetXMLDesc => 186 */
    .fn = (dispatch_fn) remoteDispatchDomainSnapshotGetXMLDesc,
    .args_filter = (xdrproc_t) xdr_remote_domain_snapshot_get_xml_desc_args,
    .ret_filter = (xdrproc_t) xdr_remote_domain_snapshot_get_xml_desc_ret,
},
...
{   /* DomainScreenshot => 211 */
    .fn = (dispatch_fn) remoteDispatchDomainScreenshot,
    .args_filter = (xdrproc_t) xdr_remote_domain_screenshot_args,
    .ret_filter = (xdrproc_t) xdr_remote_domain_screenshot_ret,
},
{   /* DomainGetState => 212 */
    .fn = (dispatch_fn) remoteDispatchDomainGetState,
    .args_filter = (xdrproc_t) xdr_remote_domain_get_state_args,
    .ret_filter = (xdrproc_t) xdr_remote_domain_get_state_ret,
},
{   /* DomainMigrateBegin3 => 213 */
...
{   /* DomainMigratePrepareTunnel3 => 215 */
...
{   /* InterfaceChangeBegin => 220 */
    .fn = (dispatch_fn) remoteDispatchInterfaceChangeBegin,
    .args_filter = (xdrproc_t) xdr_remote_interface_change_begin_args,
    .ret_filter = (xdrproc_t) xdr_void,
},
{   /* InterfaceChangeCommit => 221 */
    .fn = (dispatch_fn) remoteDispatchInterfaceChangeCommit,
    .args_filter = (xdrproc_t) xdr_remote_interface_change_commit_args,
    .ret_filter = (xdrproc_t) xdr_void,
},
{   /* InterfaceChangeRollback => 222 */
    .fn = (dispatch_fn) remoteDispatchInterfaceChangeRollback,
    .args_filter = (xdrproc_t) xdr_remote_interface_change_rollback_args,
    .ret_filter = (xdrproc_t) xdr_void,
},
{   /* DomainGetSchedulerParametersFlags => 223 */
    .fn = (dispatch_fn) remoteDispatchDomainGetSchedulerParametersFlags,
    .args_filter = (xdrproc_t) xdr_remote_domain_get_scheduler_parameters_flags_args,
    .ret_filter = (xdrproc_t) xdr_remote_domain_get_scheduler_parameters_flags_ret,
},
